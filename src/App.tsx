...
//create an array of band names; me added below
const teams = [
  {
    tid: 159,
    cid: 0,
...
class Team extends React.Component<{
  ...
  //for a single band. interchangeable w/ function
  render() {
    const oneTeam = this.props; //like saying bandNames[1]; but for each ONE (that's what "this" does)
    //was oneBand
    return (
      <div>
        <h1>School Name: {oneTeam.school}</h1>
...
function TeamList() {
  //was BandList
  //create function. in JS can only return 1 thing so list all that will return in teh App(); get all of the individual bands entered here
  return (
    <div>
      {teams.map((oneTeam) => (
        <Team {...oneTeam} />
...
//put all of the functions that want to call here, in the App() functoin
function App() {
  return (
    <div>
      <Welcome />
...
//we're calling that App function in the react.render below and all w/in it
